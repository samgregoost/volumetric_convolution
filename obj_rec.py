...
#			print(filename)
			main_itr = main_itr+1
	                print(filename)
			print(main_itr)
			loss_train, _ = sess.run([loss,training_op], feed_dict = {y:y_annot, raw_points_init:points_raw, keep_prob :0.85})
			print(j)
...
#				points = points_raw
				...
				#	print(rot_points)
					...
					loss_val, acc_val = sess.run(
                	        	[loss, accuracy], feed_dict = {y:y_annot, raw_points_init:points_raw,  keep_prob :1.0})
